...
import {Button, FormControl, Grid, List, TextField, Typography} from "@mui/material";
...
const ItemCreateForm = (props) => {
    ...
    useEffect(() => {
        ItemService.fetchCategories().then(result => {
            console.log(result);
    ...
    >
        ...
        {success && <Grid item xs={12}> <ApiSuccessAlert message="Item was created!" key={childKey}/> </Grid>}
        <Grid item xs={12}>
        ...
        >
            <FormControl>
                ...
                <List>
                    <NestedItem categories={categories} setCategory={setCategory}>Categories</NestedItem>
                </List>
